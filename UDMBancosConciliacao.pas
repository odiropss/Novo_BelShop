...
// Nome da Unit: UDMBancosConciliacao
// Nome do Form: DMConciliacao
...
type
  TDMConciliacao = class(TDataModule)
    ...
    CDS_CMDepositosDESC_HISTORICO: TStringField;
    SDS_CMDepositosAnalise: TSQLDataSet;
    DSP_CMDepositosAnalise: TDataSetProvider;
    CDS_CMDepositosAnalise: TClientDataSet;
    DS_CMDepositosAnalise: TDataSource;
    CDS_CMDepositosAnaliseNOME_EMP: TStringField;
    CDS_CMDepositosAnaliseCX_MTZ: TFMTBCDField;
    CDS_CMDepositosAnaliseDEPOSITO: TFMTBCDField;
    ...
    CDS_CMDepositosAnaliseREL_ENTREGUE: TStringField;
    SDS_CMDepAnaliseDocRel: TSQLDataSet;
    DSP_CMDepAnaliseDocRel: TDataSetProvider;
    CDS_CMDepAnaliseDocRel: TClientDataSet;
    DS_CMDepAnaliseDocRel: TDataSource;
    CDS_CMDepAnaliseDocRelNUM_DOCTO: TIntegerField;
    CDS_CMDepAnaliseDocRelUSU_CRIACAO: TIntegerField;
    CDS_CMDepAnaliseDocRelDES_USU_CRIACAO: TStringField;
    CDS_CMDepAnaliseDocRelDTA_CRIACAO: TDateField;
    CDS_CMDepAnaliseDocRelHRA_CRIACAO: TTimeField;
    CDS_CMDepAnaliseDocRelDTA_MOVTO: TDateField;
    CDS_CMDepAnaliseDocRelCOD_LINX: TIntegerField;
    CDS_CMDepAnaliseDocRelNOME_LOJA: TStringField;
    CDS_CMDepAnaliseDocRelVLR_MATRIZ: TFMTBCDField;
    CDS_CMDepAnaliseDocRelVLR_DEPOSITOS: TFMTBCDField;
    CDS_CMDepAnaliseDocRelVLR_DESPESAS: TFMTBCDField;
    CDS_CMDepAnaliseDocRelVLR_OUTROS: TFMTBCDField;
    CDS_CMDepAnaliseDocRelVLR_TOTAL: TFMTBCDField;
    CDS_CMDepAnaliseDocRelOBS_FINANCEIRO: TStringField;
    CDS_CMDepAnaliseDocRelUSU_INCLUSAO: TIntegerField;
    CDS_CMDepAnaliseDocRelDES_USU_INCLUSAO: TStringField;
    CDS_CMDepAnaliseDocRelDTA_INCLUSAO: TDateField;
    CDS_CMDepAnaliseDocRelHRA_INCLUSAO: TTimeField;
    CDS_CMDepAnaliseDocRelUSU_IMPRESSAO: TIntegerField;
    CDS_CMDepAnaliseDocRelDES_USU_IMPRESSAO: TStringField;
    CDS_CMDepAnaliseDocRelDTA_IMPRESSAO: TDateField;
    CDS_CMDepAnaliseDocRelHRA_IMPRESSAO: TTimeField;
    CDS_CMDepAnaliseDocRelUSU_RECEBE: TIntegerField;
    CDS_CMDepAnaliseDocRelDES_USU_RECEBE: TStringField;
    CDS_CMDepAnaliseDocRelDTA_RECEBE: TDateField;
    CDS_CMDepAnaliseDocRelHRA_RECEBE: TTimeField;
    SDS_CMDepAnaliseDocRelNUM_DOCTO: TIntegerField;
    SDS_CMDepAnaliseDocRelUSU_CRIACAO: TIntegerField;
    SDS_CMDepAnaliseDocRelDES_USU_CRIACAO: TStringField;
    SDS_CMDepAnaliseDocRelDTA_CRIACAO: TDateField;
    SDS_CMDepAnaliseDocRelHRA_CRIACAO: TTimeField;
    SDS_CMDepAnaliseDocRelDTA_MOVTO: TDateField;
    SDS_CMDepAnaliseDocRelCOD_LINX: TIntegerField;
    SDS_CMDepAnaliseDocRelNOME_LOJA: TStringField;
    SDS_CMDepAnaliseDocRelVLR_MATRIZ: TFMTBCDField;
    SDS_CMDepAnaliseDocRelVLR_DEPOSITOS: TFMTBCDField;
    SDS_CMDepAnaliseDocRelVLR_DESPESAS: TFMTBCDField;
    SDS_CMDepAnaliseDocRelVLR_OUTROS: TFMTBCDField;
    SDS_CMDepAnaliseDocRelVLR_TOTAL: TFMTBCDField;
    SDS_CMDepAnaliseDocRelOBS_FINANCEIRO: TStringField;
    SDS_CMDepAnaliseDocRelUSU_INCLUSAO: TIntegerField;
    SDS_CMDepAnaliseDocRelDES_USU_INCLUSAO: TStringField;
    SDS_CMDepAnaliseDocRelDTA_INCLUSAO: TDateField;
    SDS_CMDepAnaliseDocRelHRA_INCLUSAO: TTimeField;
    SDS_CMDepAnaliseDocRelUSU_IMPRESSAO: TIntegerField;
    SDS_CMDepAnaliseDocRelDES_USU_IMPRESSAO: TStringField;
    SDS_CMDepAnaliseDocRelDTA_IMPRESSAO: TDateField;
    SDS_CMDepAnaliseDocRelHRA_IMPRESSAO: TTimeField;
    SDS_CMDepAnaliseDocRelUSU_RECEBE: TIntegerField;
    SDS_CMDepAnaliseDocRelDES_USU_RECEBE: TStringField;
    SDS_CMDepAnaliseDocRelDTA_RECEBE: TDateField;
    SDS_CMDepAnaliseDocRelHRA_RECEBE: TTimeField;
