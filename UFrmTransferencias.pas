  ...
  Begin
    ...
    Try // Try da Transação
      ...
      MySql:=' UPDATE SOL_TRANSFERENCIA_CD so'+
             ...
             '                    ''Produto Sem Saldo no Centro de Distribuição'''+
...
//           If DMTransferencias.CDS_Busca.FieldByName('Qtd_A_Transf').AsCurrency>DMTransferencias.CDS_Busca1.FieldByName('Qtd_A_Transf').AsCurrency Then
        ...
        //======================================================================
        // Só Atualiza Es_Estoques_CD se Atualizou Es_Estoque_Loja ==============
        //======================================================================
        If bProcessou Then
        Begin
...
Begin
  ...
  MySql:=' SELECT CURRENT_DATE DTA_MOVTO, e.codproduto cod_produto,'+
         ...
         // OdirApagar - 26/09/2018 - São todos os Fornecedores
...
//OdirAqui 2.Fim
  ...
  //============================================================================
  // Busca Solicitações Efetuadas Pelas Lojas ==================================
  //============================================================================
//OdirAqui 3.Inicio
