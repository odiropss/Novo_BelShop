...
type
  TDMComissaoVendedor = class(TDataModule)
    ...
    CDS_V_CampComissoes: TClientDataSet;
    DS_V_CampComissoes: TDataSource;
    CDS_V_CampComissoesCODIGO: TIntegerField;
    CDS_V_CampComissoesDESCRICAO: TStringField;
    CDS_V_CampComissoesCOD_CAMP: TIntegerField;
    CDS_V_CampComissoesCAMPANHA: TStringField;
    CDS_V_CampComissoesQTD_ITENS: TIntegerField;
    CDS_V_CampComissoesPONTOS_ITEM: TFMTBCDField;
    CDS_V_CampComissoesVLR_COMIS_ITENS: TFMTBCDField;
    CDS_V_CampComissoesVLR_FAT: TFMTBCDField;
    CDS_V_CampComissoesPER_FAT: TFMTBCDField;
    CDS_V_CampComissoesVLR_COMIS_FAT: TFMTBCDField;
    CDS_V_CampComissoesTOT_COMISSAO: TFMTBCDField;
