...
Function TDMAtualizaSeteHoras.ConectaMPMS: Boolean;
Var
  MySql: String;
  i: Integer;
  s: String;
    ...
    Begin
      ...
      Begin
        ...
        Begin
           ...
           sEndIP:=DMAtualizaSeteHoras.CDS_Busca.FieldByName('ENDERECO_IP').AsString;

           // Tipo de Conexão: TCP/IP
           s:=sEndIP+':'+
              IncludeTrailingPathDelimiter(DMAtualizaSeteHoras.CDS_Busca.FieldByName('PASTA_BASE_DADOS').AsString)+
                                           DMAtualizaSeteHoras.CDS_Busca.FieldByName('DES_BASE_DADOS').AsString;
