...
var
  ...
  bgFechadoRenato, bgAmbosRenato: Boolean; // Se é pesquisa por Lançamento fechado
implementation
...
Begin
  ...
  // Apresenta Movtos para Analise de Conciliação de Depósitos =================
  If bgProcessar Then
  Begin
    bgAmbosRenato:=False;
...
End; // CONCILIAÇÕES DEPOSITOS - Apresenta Documento Financeiro`>>>>>>>>>>>>>>>>

// CONCILIAÇÕES DEPOSITOS - Atualiza Totais e Informa Data de Depositos >>>>>>>>
...
Begin
  ...
  Begin
    ...
    Begin
      ...
      Begin
        ...
        Begin
          ...
          DMConciliacao.CDS_CMDepositosAnaliseOBSERVACOES.AsString:='Depósitos em: '+f_Troca('.','/',f_Troca('-','/',
    ...
    // NÃO CONCILICADO - Atualiza Totais =======================================
...
End; // CONCILIAÇÕES DEPOSITOS - Atualiza Totais e Informa Data de Depositos >>>

// CONCILIAÇÕES DEPOSITOS - Atualiza Total de Depósitos e Total Geral >>>>>>>>>>
...
Begin
  ...
  OdirPanApres.Caption:='AGUARDE !! FASE 2/6 - Atualizando Totais de Depósitos...';
  OdirPanApres.Width:=Length(OdirPanApres.Caption)*10;
  OdirPanApres.Left:=ParteInteiro(FloatToStr((FrmBancoExtratos.Width-OdirPanApres.Width)/2));
  OdirPanApres.Top:=ParteInteiro(FloatToStr((FrmBancoExtratos.Height-OdirPanApres.Height)/2))-20;
  OdirPanApres.Font.Style:=[fsBold];
  ...
  MySql:=' SELECT'+
         ...
         Begin
           ...
           If Not bgFechadoRenato Then
            MySql:=
             MySql+' AND fh.tip_aux IS NULL'; // Não Fechados Pelo Renato
  ...
  // Atualiza Total das Lojas ==================================================
  OdirPanApres.Caption:='AGUARDE !! FASE 3/6 - Atualiza Diferença de Depósitos Conciliados...';
  OdirPanApres.Width:=Length(OdirPanApres.Caption)*10;
  OdirPanApres.Left:=ParteInteiro(FloatToStr((FrmBancoExtratos.Width-OdirPanApres.Width)/2));
  OdirPanApres.Top:=ParteInteiro(FloatToStr((FrmBancoExtratos.Height-OdirPanApres.Height)/2))-20;
  OdirPanApres.Font.Style:=[fsBold];
  ...
  // Atualiza Diferença de Depositos Conciliados ===============================
  //============================================================================
End; // CONCILIAÇÕES DEPOSITOS - Atualiza Total de Depósitos e Total Geral >>>>>

// CONCILIAÇÕES DEPOSITOS - Atualiza Valores Faturamento e Salao >>>>>>>>>>>>>>>
...
Var
  ...
  sData: String;
Begin
  OdirPanApres.Caption:='AGUARDE !! FASE 4/6 - Apropriando Valores em Dinheiro do Período de '+sDiaInicial+' a '+sDiaFinal;
  OdirPanApres.Width:=Length(OdirPanApres.Caption)*10;
  OdirPanApres.Left:=ParteInteiro(FloatToStr((FrmBancoExtratos.Width-OdirPanApres.Width)/2));
  OdirPanApres.Top:=ParteInteiro(FloatToStr((FrmBancoExtratos.Height-OdirPanApres.Height)/2))-20;
  OdirPanApres.Font.Style:=[fsBold];
...
//         '                                                    and   mv1.serie=mf.serie_venda)'+
  ...
  // Seleciona Pagtos do Salão TRINKS em Dinheiro do Dia =======================
         ' UNION'+
  ...
  OdirPanApres.Visible:=False;
  Screen.Cursor:=crDefault;
End; // CONCILIAÇÕES DEPOSITOS - Atualiza Valores Faturamento e Salao >>>>>>>>>>

// CONCILIAÇÕES DEPOSITOS - Apresenta Movtos para Analise >>>>>>>>>>>>>>>>>>>>>>
Procedure TFrmBancoExtratos.ApresentaDepositosAnalise(sDocFinan: String='0');
Var
  MySql, MySql1, MySql2,

  sDiaInicio, sDiaFim: String; // Datas para Pesquise de Dias de Depósitos
Begin

  // FASE 1 - Monta Movimentos de Caixa ========================================
  OdirPanApres.Caption:='AGUARDE !! FASE 1/6 - Montando Analise de Conciliação Depósitos...';
  OdirPanApres.Width:=Length(OdirPanApres.Caption)*10;
  OdirPanApres.Left:=ParteInteiro(FloatToStr((FrmBancoExtratos.Width-OdirPanApres.Width)/2));
  OdirPanApres.Top:=ParteInteiro(FloatToStr((FrmBancoExtratos.Height-OdirPanApres.Height)/2))-20;
  OdirPanApres.Font.Style:=[fsBold];
  ...
  If (Not bgAmbosRenato) And (bgFechadoRenato)     Then sgMensagem:='ANALISE CONCILIAÇÃO CAIXAS: Fechados';
  If (Not bgAmbosRenato) And (Not bgFechadoRenato) Then sgMensagem:='ANALISE CONCILIAÇÃO CAIXAS: Abertos';
  If (bgAmbosRenato)  Then sgMensagem:='ANALISE CONCILIAÇÃO CAIXAS: Abertos/Fechados';
  ...
  MySql:=
   MySql+' GROUP BY 1,2,13,14,15,16,17,18,19';
         ...
         // APRESENTA VALORES NÃO CONCILIADOS
  MySql1:=
   MySql1+' UNION'+
         ...
         Begin
           ...
           If Not bgFechadoRenato Then
            MySql1:=
             MySql1+' AND fh.tip_aux IS NULL'; // Não Fechados Pelo Renato
         End; // If Not bgAmbosRenato Then
  ...
  MySql1:=
   MySql1+' GROUP BY 2';
         ...
         // APRESENTA TOTAL DOS VALORES NÃO CONCILIADOS
  MySql2:=
   MySql2+' UNION'+

         ' SELECT'+
         ' ''TOTAL DE VALORES NÃO CONCILIADOS'','+
         ' md.dta_docto DTA_DOCTO,'+
         ' NULL LOJA_DINHEIRO,'+
         ' NULL SALAO_DINHEIRO,'+
         ' NULL DIA_DINHEIRO,'+
         ...
         Begin
           ...
           If Not bgFechadoRenato Then
            MySql2:=
             MySql2+' AND fh.tip_aux IS NULL'; // Não Fechados Pelo Renato
         End; // If Not bgAmbosRenato Then
  ...
  DMConciliacao.CDS_CMDepositosAnaliseNOME_EMP.AsString:='Período de '+sDiaInicio+' a '+sDiaFim;
  ...
  // FASE 2 - Atualizando Totais de Depósitos ==================================
  // FASE 3 - Atualiza Diferença de Depositos Conciliados ======================
  ...
  msg('Geração dos Movimentos'+cr+'Efetuado com SUCESSO !!','A');
  
End; // CONCILIAÇÕES DEPOSITOS - Apresenta Movtos para Analise >>>>>>>>>>>>>>>>>
...
//
//  OdirPanApres.Visible:=False;
//end; // CONCILIAÇÕES PAGTOS/DEPOSITOS - Atualiza Depositos/Faturamento em Dinheiro no Dia >>>>>

// CONCILIAÇÕES PAGTOS/DEPOSITOS - Fechamento do Dia no Banco de Dados >>>>>>>>>
...
Begin
  ...
  OdirPanApres.Visible:=False;
  Screen.Cursor:=crDefault;
End; // CONCILIAÇÕES PAGTOS/DEPOSITOS - Fechamento do Dia no Banco de Dados >>>>

// CONCILIAÇÕES PAGTOS/DEPOSITOS - Verifica se Dia Já Fechado pelo Renato >>>>>>
...
Begin
  ...
  If Trim(DMBelShop.CDS_BuscaRapida.FieldByName('Cod_Aux').AsString)='' Then
   Result:=False; // Não Encontrou Fechamento do Dia da Loja

  DMBelShop.CDS_BuscaRapida.Close;
End; // CONCILIAÇÕES PAGTOS/DEPOSITOS - Verifica se Dia Já Fechado pelo Renato >
...
Begin
  ...
  Begin
    OdirPanApres.Visible:=False;
    If msg('Sem Extrato no Período Solicitado !!'+cr+'Deseja Continuar ??','C')=2 Then
    Begin
      DMConciliacao.CDS_CMExtratosDep.Close;
      Exit;
    End;
  ...
  Begin
    ...
    If Execute then
     Begin
       ...
       Begin
         If Application.MessageBox(pChar('DATA da Criação do Arquivo é '+DateTimeToStr(FileDateToDateTime(FileAgeCreate(EdtBanrisulPastaArquivo.Text)))+cr+cr+
                                         'Inferior ao dia de Hoje !!'+cr+cr+'DESEJA Gerar o Arquivo Novamente ??'), 'ATENÇÃO !!', 36) = IdYes Then
         Begin
           EditorBanrisulImpExtrato.Lines.Clear;
           EdtBanrisulPastaArquivo.Clear;
           FreeAndNil(OpenDialog);
           Exit;
         End; // If Application.MessageBox(pChar('DATA da Criação do Arquivo é '...
       End;
...
Var
  ...
  // Function Interna - Verifica se Já esta no Docto Financeiro >>>>>>>>>>>>>>>>
  ...
  Begin
    ...
    Begin
      ...
      // Verifica se Já Esta no Docto Financeiro de Entrega para o Renato ======
      ...
      Begin
        ...
        msg('Impossível Retira a Conciliação !!'+cr+'Existe Movimento Já Incluído'+cr+'no Documento Financeiro Número: '+Trim(DMBelShop.CDS_BuscaRapida.FieldByName('Des_Aux1').AsString),'A');
        DMBelShop.CDS_BuscaRapida.Close;
        DMBelShop.CDS_Busca.Close;
        Result:=False;
        Break;
    ...
    DMBelShop.CDS_Busca.Close;
    Screen.Cursor:=crDefault;
  End; // Function Interna - Verifica se Já esta no Docto Financeiro >>>>>>>>>>>>
...
begin
  ...
  If bConcRetira Then
  Begin
    // Verifica se Pode retira a Conciliação Devido Já Estar no Docto Financeiro
    ...
    Try
      ...
      // Busca Observação de Nao Conciliado ====================================
...
begin
  ...
  // Verifica se Dia Já Fechado Pelo Renato ====================================
  ...
  Begin
    PlaySound(PChar('SystemExclamation'), 0, SND_ASYNC);
    msg('Impossível Conciliar !!'+cr+'Dia '+Trim(DMConciliacao.CDS_CMDepositosDTA_DOCTO.AsString)+' da '+cr+
        'Loja: '+Trim(DMConciliacao.CDS_CMDepositosRAZAO_SOCIAL.AsString)+cr+cr+
        'Já Conciliado e Fechado !!','A');
...
begin
  ...
  If msg(DMConciliacao.CDS_CMDepositosRAZAO_SOCIAL.AsString+cr+
         ...
         'O Dia e a Loja Estão Seleciondas CORRETAMENTE ??','C')=2 Then
  Begin
    Dbg_ConcManutDepositos.Options:=[dgTitles,dgIndicator,dgColLines,dgRowLines,dgTabs,dgAlwaysShowSelection];
    Dbg_ConcManutDepositos.SetFocus;
    Exit;
  ...
  Begin
    msg(DMConciliacao.CDS_CMDepositosRAZAO_SOCIAL.AsString+cr+
        'Dia '+DMConciliacao.CDS_CMDepositosDTA_DOCTO.AsString+cr+cr+
        'SEM Movimento NÃO CONCILIADO !!','A');
    DMBelShop.CDS_BuscaRapida.Close;
    Dbg_ConcManutDepositos.Options:=[dgTitles,dgIndicator,dgColLines,dgRowLines,dgTabs,dgAlwaysShowSelection];
    Dbg_ConcManutDepositos.SetFocus;
    Exit;
  ...
  While b do
  Begin
    If InputQuery('Observação de Não Conciliado','',sObsNaoConc) then
     Begin
       If Trim(sObsNaoConc)='' Then
        Begin
          If msg('SEM Observação de Não Conciliado !!'+cr+cr+'Esta Correto ??','C')=2 Then
           Begin
             bgProcessar:=False;
           End
          Else
     ...
     End
    Else // If InputQuery('Observação de Não Conciliado','',sObsNaoConc) then
     Begin
       bgProcessar:=False;
       Break;
     End; // If InputQuery('Observação de Não Conciliado','',sObsNaoConc) then
  End; // While b do
  ...
  If bgProcessar Then
  Begin
    OdirPanApres.Caption:='AGUARDE !! Atualizando Registros Não Conciliados...';
    OdirPanApres.Width:=Length(OdirPanApres.Caption)*10;
    OdirPanApres.Left:=ParteInteiro(FloatToStr((FrmBancoExtratos.Width-OdirPanApres.Width)/2));
    OdirPanApres.Top:=ParteInteiro(FloatToStr((FrmBancoExtratos.Height-OdirPanApres.Height)/2))-20;
    OdirPanApres.Font.Style:=[fsBold];
...
Var
  ...
  Begin
    ...
    Try // Try da Transação
      ...
      // Informa Inclusão no Documento Financeiro no Tab_Auxiliar ==============
      // 24 => CONCILIAÇÃO DE DEPÓSITOS:
      //       - DES_AUX  = Observação Financeira
      //       ==>> DES_AUX1 = Número do Documento Financeiro de Entrega para o Renato
...
begin
  ...
  Begin
    ...
    // Verifica se Loja Esta Como Não Conciliada ===============================
    ...
    // Verifica se a Loja Esta Repetida como Não Conciliada ====================
    ...
    Begin
      PlaySound(PChar('SystemExclamation'), 0, SND_ASYNC);
      msg('Loja Já Fechada por Entrega do'+cr+'Documento Financeiro Número: '+
    ...
    Begin
      PlaySound(PChar('SystemExclamation'), 0, SND_ASYNC);
      msg('Loja já Incluída no'+cr+'Documento Financeiro Número: '+
          Trim(DMConciliacao.CDS_CMDepositosAnaliseNUM_RELATORIO.AsString),'A');
      Dbg_DepAnalise.SetFocus;
      Exit;
    End; // If Trim(DMConciliacao.CDS_CMDepositosAnaliseNUM_RELATORIO.AsString)<>'' Then
    ...
    // Busca Numero do Docto Financeiro Aberto/Não Impresso ====================
    MySql:=' SELECT FIRST 1 r.num_docto'+ // Docto Financeiro sem Emissão em Aberto
           ' FROM FIN_CONCILIACAO_DEP_REL r'+
    ...
    Begin
      msg('Erro na Inclusão da Loja !'+cr+cr+'Entrar em Contato com o Odir !!','A');
      Exit;
    End; // If Not IncluiDoctoFinanceiro Then

    msg('Loja Incluida com SUCESSO !!'+cr+cr+'Documento Financeiro Nº: '+sCodDoc,'A');

    // OdirApagar - 23/10/2018 - Não Apresenta a Cada Incluisão
  ...
  Begin
    ...
    Begin
      PlaySound(PChar('SystemExclamation'), 0, SND_ASYNC);
      msg('Impossível Abrir !!'+cr+cr+'Loja Já Fechada por Entrega do'+cr+
          'Documento Financeiro Número: '+
          Trim(DMConciliacao.CDS_CMDepositosAnaliseNUM_RELATORIO.AsString),'A');
      Dbg_DepAnalise.SetFocus;
      Exit;
    End; // If Trim(DMConciliacao.CDS_CMDepositosAnaliseNUM_RELATORIO.AsString)<>'' Then
    ...
    Begin
      PlaySound(PChar('SystemExclamation'), 0, SND_ASYNC);
      msg('Impossível Fechar !!'+cr+cr+'Loja Só Pode ser Fechada por'+cr+
          'Entrega do Docto Financeiro Número: '+
          Trim(DMConciliacao.CDS_CMDepositosAnaliseNUM_RELATORIO.AsString),'A');
      Dbg_DepAnalise.SetFocus;
      Exit;
    End; // If Trim(DMConciliacao.CDS_CMDepositosAnaliseNUM_RELATORIO.AsString)<>'' Then
...
begin
  ...
  Begin
    PlaySound(PChar('SystemExclamation'), 0, SND_ASYNC);
    msg('Impossível Alterar !!'+cr+'Dia '+f_Troca('.','/',sgDia)+' da '+cr+
  ...
  Begin
    ...
    Begin
      ...
      msg('Impossível Alterar !!'+cr+'Dia '+f_Troca('.','/',sgDia)+' da '+cr+
          'Loja: '+Trim(DMConciliacao.CDS_CMDepositosAnaliseNOME_EMP.AsString)+cr+cr+
          'Existem Documentos NÃO Conciliados !!','A');
      DMConciliacao.CDS_CMDepositosAnalise.RecNo:=iRecNo;
      Dbg_DepAnalise.SetFocus;
      Exit;
    End; // If DMConciliacao.CDS_CMDepositosAnalise.Locate('NOME_EMP; DTA_DOCTO; ORDEM; OBSERVACOES',VarArrayOf([sNomeLoja, sDtaMov, 9, '']),[]) Then
  ...
  Begin
    PlaySound(PChar('SystemExclamation'), 0, SND_ASYNC);
    msg('Movimento já Incluído no'+cr+'Docto Financeiro Número: '+
    Trim(DMConciliacao.CDS_CMDepositosAnaliseNUM_RELATORIO.AsString),'A');
    Dbg_DepAnalise.SetFocus;
    Exit;
  End; // If Trim(DMConciliacao.CDS_CMDepositosAnaliseNUM_RELATORIO.AsString)<>'' Then
  ...
  Begin
    bgProcessar:=True;
    If InputQueryOdir('CONCILIAÇÃO DEPÓSITOS', 'Informe a Observação Financeira',sObsFinan,210) then
     Begin
       If Length(Trim(sObsFinan))>50 Then
        Begin
          msg('Número de Caracteres Inválido !!'+cr+cr+'Máximo de 50 Caracteres !!','A');
          bgProcessar:=False;
        End
       Else
        Begin
        ...
        End; // If Trim(sObsNaoConc)='' Then
     End
    Else // If InputQuery('Observação Financeira','',sObsFinan) then
     Begin
       bgProcessar:=False;
       Break;
     End; // If InputQuery('Observação Financeira','',sObsFinan) then
  End; // While b do

  If bgProcessar Then
  Begin
    OdirPanApres.Caption:='AGUARDE !! Atualizando Observação Financeira...';
    OdirPanApres.Width:=Length(OdirPanApres.Caption)*10;
    OdirPanApres.Left:=ParteInteiro(FloatToStr((FrmBancoExtratos.Width-OdirPanApres.Width)/2));
    OdirPanApres.Top:=ParteInteiro(FloatToStr((FrmBancoExtratos.Height-OdirPanApres.Height)/2))-20;
    OdirPanApres.Font.Style:=[fsBold];
    ...
    Try // Try da Transação
      ...
      // Verifica se Pode Excluir Registro se Não houver Numero do Relatório ===
      If Trim(sObsFinan)='' Then
      Begin
        MySql:=' SELECT t.tip_aux'+
               ' FROM TAB_AUXILIAR t'+
               ' WHERE t.tip_aux=24'+ // CONCILIAÇÃO DE DEPÓSITOS - OBSERVAÇÃO FINAL PARA LOJAS CONCILIADAS
      ...
      // UPDATE OR INSERT  na Observação Financeira ============================
      MySql:=' UPDATE OR INSERT INTO TAB_AUXILIAR'+
...
Var
  b, bPeriodo: Boolean; // Se Solicita período
begin
  Dbg_DepAnalise.SetFocus;
  ...
  Begin
    ...
    Begin
      ...
      Begin
        PlaySound(PChar('SystemExclamation'), 0, SND_ASYNC);
        If msg('TODOS os Movimentos de Caixas'+cr+'em ABERTO SERÃO Apresentados !!'+cr+cr+'Esra CORRETO ??','C')=2 Then
         Exit;
...
begin
  ...
  While b do
  Begin
    If InputQueryOdir('Informe o Nº (0=Não Impresso/Aberto)', 'Documento Financeiro', sNumDocto, 200) Then
     Begin
  ...
  // Se 0 (Zero) Verifi se Existe Documento Financeiro em Aberto/Não Impresso ==
  ...
  If Trim(sNumDocto)='' Then
  Begin
    msg('Não Existe Documento Financeiro em Aberto !!','A');
    Exit;
...
begin
  ...
  Begin
    ...
    Try // Try da Transação
      ...
      // Reabre Clients de Conciliação se Já Abertos ===========================
      If DMConciliacao.CDS_CMDepositosAnaliseORDEM.AsInteger=9 Then
      Begin
