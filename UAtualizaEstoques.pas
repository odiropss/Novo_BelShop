...
type
  TFrmAtualizaEstoques = class(TForm)
    ...
    // OdirApagar - Atualizado em PMovtosEmpresa - 24/01/2019
...
// OdirApagar - INICIO - Atualizado em PMovtosEmpresa - 24/01/2019
...
//    DMAtualizaEstoques.SQLC.Commit(TD);
//
//    tgMySqlErro.Add('EnderecamentosSidicomBelShop - OK  - '+sgDtaInicioProc+' a '+DateTimeToStr(Now));
//    tgMySqlErro.Add('==================================');
//    tgMySqlErro.SaveToFile(sgPath_Local+'@ODIR_AtuaLizaEstoquesProc.txt');
//
//    DateSeparator:='/';
...
//      DMAtualizaEstoques.SQLC.Rollback(TD);
//
//      tgMySqlErro.Add('EnderecamentosSidicomBelShop - ERRO -'+sgDtaInicioProc+' a '+DateTimeToStr(Now));
//      tgMySqlErro.Add('ERROR: '+e.message);
//      tgMySqlErro.Add(MySql);
//      tgMySqlErro.Add('==================================');
//      tgMySqlErro.SaveToFile(sgPath_Local+'@ODIR_AtuaLizaEstoquesProc.txt');
...
// OdirApagar - FIN - Atualizado em PMovtosEmpresa - 24/01/2019
...
// OdirApagar - Sem Central de Trocas
//         '        OR'+
//         '        (c.cod_filial=''50''))'+
...
//    sCodEmpresa   :='04';
    ...
    Begin
      // Não Rodea Mais- Todas tem Inventario <<<<<<<<<<<<<<<<<<<<<<<
        ...
        Begin
          ...
          Begin
            ...
            Except
              ...
              Begin
                Inc(i);
                tgMySqlErro.Add('IBQ_EstoqueLoja - ERRO ABERTURA -'+sgDtaInicioProc+' a '+DateTimeToStr(Now));
