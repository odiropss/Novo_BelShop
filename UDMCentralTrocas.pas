...
type
  TDMCentralTrocas = class(TDataModule)
    ...
    CDS_ContProdSeparacao: TClientDataSet;
    SDS_ContProdSeparacao: TSQLDataSet;
    DSP_ContProdSeparacao: TDataSetProvider;
    DS_ContProdSeparacao: TDataSource;
    CDS_ContProdEstatisticas: TClientDataSet;
    SDS_ContProdEstatisticas: TSQLDataSet;
    DSP_ContProdEstatisticas: TDataSetProvider;
    DS_ContProdEstatisticas: TDataSource;
    CDS_ContProdSeparacaoNOME_SEPARDOR: TStringField;
    CDS_ContProdSeparacaoLINHAS_SEPARADAS: TFMTBCDField;
    CDS_ContProdSeparacaoLINHAS_NSEPARADAS: TFMTBCDField;
    CDS_ContProdSeparacaoLINHAS_TOTAL: TIntegerField;
    CDS_ContProdSeparacaoLINHAS_PERCENTUAL: TFMTBCDField;
    CDS_ContProdSeparacaoQTD_SEPARADAS: TIntegerField;
    CDS_ContProdSeparacaoQTD_NSEPARADAS: TIntegerField;
    CDS_ContProdSeparacaoQTD_TOTAL: TIntegerField;
    CDS_ContProdSeparacaoQTD_PERCENTUAL: TFMTBCDField;
    CDS_ContProdSeparacaoORDEM: TIntegerField;
    CDS_ContProdEstatisticasDES_USUARIO: TStringField;
    CDS_ContProdEstatisticasLINHAS_TOTAL: TIntegerField;
    CDS_ContProdEstatisticasLINHAS_NAO_ALTERADAS: TIntegerField;
    CDS_ContProdEstatisticasLINHAS_ALTERADAS: TIntegerField;
    CDS_ContProdEstatisticasLINHAS_ALTERADAS_DIF_ZERO: TIntegerField;
    CDS_ContProdEstatisticasLINHAS_ALTERADAS_ZERO: TIntegerField;
    CDS_ContProdEstatisticasQTD_TOTAL_ORIGINAL: TFMTBCDField;
    CDS_ContProdEstatisticasQTD_NAO_ALTERADAS: TFMTBCDField;
    CDS_ContProdEstatisticasQTD_ALTERADAS_ORIGINAL: TFMTBCDField;
    CDS_ContProdEstatisticasQTD_ALTERADAS: TFMTBCDField;
    CDS_ContProdEstatisticasLINHAS_NFE: TFMTBCDField;
    CDS_ContProdEstatisticasLINHAS_SEM_NFE: TFMTBCDField;
    CDS_ContProdEstatisticasQTD_NFE: TFMTBCDField;
    CDS_ContProdEstatisticasQTD_SEM_NFE: TFMTBCDField;
    CDS_ContProdEstatisticasORDEM: TIntegerField;
    CDS_Depositos: TClientDataSet;
    SDS_Depositos: TSQLDataSet;
    DSP_Depositos: TDataSetProvider;
    DS_Depositos: TDataSource;
    CDS_DepositosSELECAO: TStringField;
    CDS_DepositosCOD_DEPOSITO: TIntegerField;
    CDS_DepositosNOME_DEPOSITO: TStringField;
    CDS_DepositosDISP_VENDA: TStringField;
    CDS_DepositosDISP_TRANSF: TStringField;
    CDS_ReposicaoDocsCOD_LINX: TIntegerField;
    CDS_ReposicaoDocsSEP_ORDEM: TIntegerField;
    CDS_ContProdConferencia: TClientDataSet;
    SDS_ContProdConferencia: TSQLDataSet;
    DSP_ContProdConferencia: TDataSetProvider;
    DS_ContProdConferencia: TDataSource;
    CDS_ContProdConferenciaNOME_CONFERENTE: TStringField;
    CDS_ContProdConferenciaQTD_ENVIADAS: TIntegerField;
    CDS_ContProdConferenciaQTD_NENVIADAS: TIntegerField;
