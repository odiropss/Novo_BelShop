...
type
  TDMCentralTrocas = class(TDataModule)
    ...
    CDS_ContProdConferenciaDES_USUARIO: TStringField;
    CDS_ContProdConferenciaLINHAS_TOTAL: TIntegerField;
    CDS_ContProdConferenciaLINHAS_NAO_ALTERADAS: TIntegerField;
    CDS_ContProdConferenciaLINHAS_ALTERADAS: TIntegerField;
    CDS_ContProdConferenciaLINHAS_ALTERADAS_DIF_ZERO: TIntegerField;
    CDS_ContProdConferenciaLINHAS_ALTERADAS_ZERO: TIntegerField;
    CDS_ContProdConferenciaQTD_TOTAL_ORIGINAL: TFMTBCDField;
    CDS_ContProdConferenciaQTD_NAO_ALTERADAS: TFMTBCDField;
    CDS_ContProdConferenciaQTD_ALTERADAS_ORIGINAL: TFMTBCDField;
    CDS_ContProdConferenciaQTD_ALTERADAS: TFMTBCDField;
    CDS_ContProdConferenciaLINHAS_NFE: TFMTBCDField;
    CDS_ContProdConferenciaLINHAS_SEM_NFE: TFMTBCDField;
    CDS_ContProdConferenciaQTD_NFE: TFMTBCDField;
    CDS_ContProdConferenciaQTD_SEM_NFE: TFMTBCDField;
