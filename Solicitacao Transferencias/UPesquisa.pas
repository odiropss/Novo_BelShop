...
//  If DMSolicTransf.CDS_Pesquisa.Eof Then
//  Begin
...
begin
 Try            
   ...
   DMSolicTransf.CDS_Pesquisa.Filter:=AnsiUpperCase(Campo_Pesquisa)+' LIKE ''%'+AnsiUpperCase(EdtDescricao.Text)+'%''';
   DMSolicTransf.CDS_Pesquisa.Filtered:=True;
 Except
   DMSolicTransf.CDS_Pesquisa.Filtered:=False;
   DMSolicTransf.CDS_Pesquisa.Filter:=AnsiUpperCase(Campo_Pesquisa)+'='+QuotedStr(AnsiUpperCase(EdtDescricao.Text));
   DMSolicTransf.CDS_Pesquisa.Filtered:=True;
 End;

 DMSolicTransf.CDS_Pesquisa.Locate(Campo_pesquisa,EdtDescricao.Text,[]);
end;
...
begin
  EdtCodigo.Text:=DMSolicTransf.CDS_Pesquisa.FieldByName(Campo_Codigo).AsString;
  EdtDescricao.Text:=DMSolicTransf.CDS_Pesquisa.FieldByName(Campo_Descricao).AsString;

  If Campo_Retorno1<>'' Then
   Retorno1:=DMSolicTransf.CDS_Pesquisa.FieldByName(Campo_Retorno1).AsString;

  If Campo_Retorno2<>'' Then
   Retorno2:=DMSolicTransf.CDS_Pesquisa.FieldByName(Campo_Retorno2).AsString;

  If Campo_Retorno3<>'' Then
   Retorno3:=DMSolicTransf.CDS_Pesquisa.FieldByName(Campo_Retorno3).AsString;
