      ...
      If sgCodLjLinx<>'2' Then
       Begin
         MySql:=' INSERT INTO ES_FINAN_CURVA_ABC'+
                ...
                '                   GROUP BY 1,2,3,4) DEM  ON dem.cod_prod_linx=pr.cod_produto'+
                '                                     AND dem.cod_linx='+sgCodLjLinx+
                '        LEFT JOIN ES_FINAN_CURVA_ABC fc  ON fc.cod_prod_linx=pr.cod_produto'+
                '                                        AND fc.cod_linx='+sgCodLjLinx;
       End
      Else // If sgCodLjLinx='2' Then Igual ao Cd
       Begin
         MySql:=' INSERT INTO ES_FINAN_CURVA_ABC'+
                ' (COD_LOJA, COD_PRODUTO, EST_MINIMO, EST_MAXIMO, NUM_DIAS_UTEIS,'+
                '  VLR_DEMANDAS_ANO, VLR_DEMANDAS, PER_PARTICIPACAO, IND_CURVA,'+
...
//      Begin
//        MySql:=' UPDATE OR INSERT INTO ES_FINAN_CURVA_ABC'+
//               ' (COD_LOJA, COD_PRODUTO, EST_MINIMO, EST_MAXIMO, NUM_DIAS_UTEIS,'+
//               '  VLR_DEMANDAS_ANO, VLR_DEMANDAS, PER_PARTICIPACAO, IND_CURVA,'+
//               '  QTD_DEMANDAS_ANO, QTD_DEMANDAS, PER_PART_QTD, IND_CURVA_QTD,'+
//               '  NUM_DIAS_ESTOCAGEM, QTD_TRANSITO, DTA_ATUALIZACAO, HRA_ATUALIZACAO,'+
...
//               QuotedStr(DMMovtosEmpresas.SQLQuery1.FieldByName('COD_PRODUTO').AsString)+', '+ // COD_PRODUTO
//               QuotedStr(DMMovtosEmpresas.SQLQuery1.FieldByName('EST_MINIMO').AsString)+', '+ // EST_MINIMO
//               QuotedStr(DMMovtosEmpresas.SQLQuery1.FieldByName('EST_MAXIMO').AsString)+', '+ // EST_MAXIMO
//               QuotedStr(DMMovtosEmpresas.SQLQuery1.FieldByName('NUM_DIAS_UTEIS').AsString)+', '+ // NUM_DIAS_UTEIS
//               QuotedStr(DMMovtosEmpresas.SQLQuery1.FieldByName('VLR_DEMANDAS_ANO').AsString)+', '+ // VLR_DEMANDAS_ANO
//               QuotedStr(DMMovtosEmpresas.SQLQuery1.FieldByName('VLR_DEMANDAS').AsString)+', '+ // VLR_DEMANDAS
//               QuotedStr(DMMovtosEmpresas.SQLQuery1.FieldByName('PER_PARTICIPACAO').AsString)+', '+ // PER_PARTICIPACAO
//               QuotedStr(DMMovtosEmpresas.SQLQuery1.FieldByName('IND_CURVA').AsString)+', '+ // IND_CURVA
//               QuotedStr(DMMovtosEmpresas.SQLQuery1.FieldByName('VLR_DEMANDAS_ANO').AsString)+', '+ // VLR_DEMANDAS_ANO
//               QuotedStr(DMMovtosEmpresas.SQLQuery1.FieldByName('QTD_DEMANDAS').AsString)+', '+ // QTD_DEMANDAS
//               QuotedStr(DMMovtosEmpresas.SQLQuery1.FieldByName('PER_PART_QTD').AsString)+', '+ // PER_PART_QTD
//               QuotedStr(DMMovtosEmpresas.SQLQuery1.FieldByName('IND_CURVA_QTD').AsString)+', '+ // IND_CURVA_QTD
//               QuotedStr(DMMovtosEmpresas.SQLQuery1.FieldByName('NUM_DIAS_ESTOCAGEM').AsString)+', '+ // NUM_DIAS_ESTOCAGEM
//               QuotedStr(DMMovtosEmpresas.SQLQuery1.FieldByName('QTD_TRANSITO').AsString)+', '+ // QTD_TRANSITO
//               QuotedStr(DMMovtosEmpresas.SQLQuery1.FieldByName('DTA_ATUALIZACAO').AsString)+', '+ // DTA_ATUALIZACAO
//               QuotedStr(DMMovtosEmpresas.SQLQuery1.FieldByName('HRA_ATUALIZACAO').AsString)+', '+ // HRA_ATUALIZACAO
//               QuotedStr(DMMovtosEmpresas.SQLQuery1.FieldByName('USU_ALTERA').AsString)+', '+ // USU_ALTERA
//               QuotedStr(DMMovtosEmpresas.SQLQuery1.FieldByName('DTA_ALTERA').AsString)+', '+ // DTA_ALTERA
//               QuotedStr(DMMovtosEmpresas.SQLQuery1.FieldByName('COD_PROD_LINX').AsString)+', '+ // COD_PROD_LINX
//               QuotedStr(DMMovtosEmpresas.SQLQuery1.FieldByName('COD_LINX').AsString)+')'+ // COD_LINX
//               ' MATCHING (COD_LOJA, COD_PROD_LINX, COD_LINX)';
//        DMMovtosEmpresas.SQLC.Execute(MySql,nil,nil);
//
//        INC(iRegNo);
//        i:=iRegNo;
