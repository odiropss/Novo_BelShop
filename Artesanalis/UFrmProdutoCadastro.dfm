object FrmProdutoCadastro: TFrmProdutoCadastro
  ...
  object Gb_Principal: TGroupBox
    ...
    object Pan_Solicitacoes: TPanel
      ...
      object Bt_ProdutoSalvar: TJvXPButton
        Tag = 99
        Left = 1
        Top = 1
        Width = 124
      ...
      object Bt_ProdutoAbandonar: TJvXPButton
        ...
        Font.Style = [fsBold]
        ParentFont = False
        OnClick = Bt_ProdutoAbandonarClick
      end
      object Bt_ProdutoExcluir: TJvXPButton
        ...
        Font.Style = [fsBold]
        ParentFont = False
        OnClick = Bt_ProdutoExcluirClick
      end
    end
    object Pan_ProdutoSolic: TPanel
      ...
      object Gb_Produto: TGroupBox
        ...
        object EdtProdutoCod: TCurrencyEdit
          ...
          OnExit = EdtProdutoCodExit
        end
        object Bt_ProdutoBusca: TJvXPButton
          Tag = 92
          Left = 71
          Top = 17
          Width = 24
